...
import logo6 from "../../../../public/logos/luxury-logo.jpg";
import logo7 from "../../../../public/logos/png-logo-2.png";
import logo8 from "../../../../public/logos/red zaman logo copy.png";

const PartnersSection = () => {
  const PartnersLogos = [logo1, logo2, logo4, logo5, logo6, logo7, logo8];
    ...
    <section className="relative py-16 lg:py-24 bg-gradient-to-br from-gray-50 to-blue-50 overflow-hidden">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          ...
          <div className="flex mb-8">
            <div className="animate-marquee flex space-x-8 pr-8">
              {PartnersLogos.map((logo, index) => (
                <div
                  key={index}
                  className="flex-shrink-0 flex items-center justify-center  p-1   transition-all duration-300"
          ...
          <div className="flex">
            <div className="animate-marqueeReverse flex space-x-8 pr-8">
              {[...PartnersLogos].reverse().map((logo, index) => (
                <div
                  key={`rev-${index}`}
                  className="flex-shrink-0 flex items-center justify-center  p-1   transition-all duration-300"
                  style={{ width: "160px", height: "160px" }}
            ...
            <div
              className="animate-marqueeReverse flex space-x-8 pr-8"
              aria-hidden="true"
            >
              {[...PartnersLogos].reverse().map((logo, index) => (
                <div
